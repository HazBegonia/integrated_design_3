...
# -*- coding: utf-8 -*-
class Z:
    def __init__(self, address1, address2, travel_mode, preference, avoid_highway, API_KEY=None, total_distance_km=None, total_duration_min=None, travel_instructions=None):
